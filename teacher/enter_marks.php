            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="enter_marks.php">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0"><i class="fas fa-pen me-2"></i>Enter Marks</h5>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="exam_name" id="exam_name" class="form-control" placeholder="Enter exam name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="total_marks" id="total_marks" class="form-control" placeholder="Enter total marks">
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" name="marks_<?php echo $student['id']; ?>" class="form-control" placeholder="Enter marks" min="0" max="100">
                                                        </td>
                                                    </tr>
                                                    <?php endwhile; ?>
                                                </tbody>

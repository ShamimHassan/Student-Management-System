...
$students_query = "SELECT DISTINCT s.id, s.student_id, s.first_name, s.last_name, s.email, s.phone, c.course_name
                   FROM students s 
                            ...
                            <div class="card-body">
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-info"><?php echo htmlspecialchars($student['course_name']); ?></span>
                                                    </td>
                                                    <td>
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            <button class="btn btn-sm btn-outline-info" title="View Performance">
                                ...
                                <?php else: ?>
                                    <div class="text-center py-5">
                                        ...
                                        <p class="text-muted">No students are enrolled in your courses.</p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>

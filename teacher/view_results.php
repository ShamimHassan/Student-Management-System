...
$results_query = "SELECT r.*, s.first_name, s.last_name, s.student_id, c.course_name, c.course_code
                  FROM results r 
                  JOIN students s ON r.student_id = s.id 
                  JOIN courses c ON r.course_id = c.id 
                  WHERE c.id = (SELECT subject_id FROM users WHERE id = ?)
                  ORDER BY r.exam_date DESC, s.first_name, s.last_name";
...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0"><i class="fas fa-chart-bar me-2"></i>View Results</h5>
                            </div>
                            <div class="card-body">
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-sm btn-outline-primary" onclick="editResult(<?php echo $result['id']; ?>)">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-outline-danger" onclick="deleteResult(<?php echo $result['id']; ?>)">
                                ...
                                <?php else: ?>
                                    <div class="text-center py-5">
                                        ...
                                        <a href="enter_marks.php" class="btn btn-primary">Enter Marks</a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
    ...
    <script>
        function editResult(id) {
            ...
            alert('Edit result with ID: ' + id);
        }
        
        function deleteResult(id) {
            if(confirm('Are you sure you want to delete this result?')) {
                // Placeholder for delete functionality
                alert('Delete result with ID: ' + id);
            }
        }
    </script>
</body>
